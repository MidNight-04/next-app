...
//   const { userName, activeUser, token } = useAuthStore();
...
//   console.log(
//     usersQuery.data?.filter(m => m.roles?.name?.toLowerCase() === 'client')
//   );
...
//                     m => m.roles?.name?.toLowerCase() === 'client'
//                   ) || [],
//                   m => `${m.name} (${m._id})`
//                 )
//               )}
...
//                 toOptions(
//                   usersQuery.data?.filter(
//                     m => m.roles?.name?.toLowerCase() === 'admin'
//                   ) || [],
//                   m => `${m.firstname + ' ' + m.lastname} (${m.employeeID})`
//                 )
//               )}
//               {renderSelect(
//                 'Architect',
...
//                 toOptions(
//                   usersQuery.data?.filter(
//                     m => m.roles?.name?.toLowerCase() === 'architect'
//                   ) || [],
//                   m => `${m.firstname + ' ' + m.lastname} (${m.employeeID})`
//                 )
//               )}
...
//                 toOptions(
//                   usersQuery.data?.filter(
//                     m => m.roles?.name?.toLowerCase() === 'sr. engineer'
//                   ) || [],
//                   m => `${m.firstname + ' ' + m.lastname} (${m.employeeID})`
//                 )
//               )}
...
//                 toOptions(
//                   usersQuery.data?.filter(
//                     m => m.roles?.name?.toLowerCase() === 'site engineer'
//                   ) || [],
//                   m => `${m.firstname + ' ' + m.lastname} (${m.employeeID})`
//                 )
//               )}
...
//                 toOptions(
//                   usersQuery.data?.filter(
//                     m => m.roles?.name?.toLowerCase() === 'accountant'
//                   ) || [],
//                   m => `${m.firstname + ' ' + m.lastname} (${m.employeeID})`
//                 )
//               )}
...
//                 toOptions(
//                   usersQuery.data?.filter(
//                     m => m.roles?.name?.toLowerCase() === 'operations'
//                   ) || [],
//                   m => `${m.firstname + ' ' + m.lastname} (${m.employeeID})`
//                 )
//               )}
...
//                 toOptions(
//                   usersQuery.data?.filter(
//                     m => m.roles?.name?.toLowerCase() === 'sales'
//                   ) || [],
//                   m => `${m.firstname + ' ' + m.lastname} (${m.employeeID})`
//                 )
//               )}
